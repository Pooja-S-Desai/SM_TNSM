...
def run_migration_optimizer_integrated_mcf_arc(
    ...
    init_assign,
    *,
    objective_type: str = "min_dev",     # also supports migration_cost
    ...
    elif obj == "migration_cost":
        # Match the shortest-path implementation: no load-balancing base term.
        base_obj = 0.0

    else:
        raise ValueError(f"Unknown objective_type={objective_type}. Use: maxmin, min_max_util, min_sum_util, min_dev, variance, migration_cost")
